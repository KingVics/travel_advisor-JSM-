        ...
        <Card elevation={6}>
            ...
            <CardContent>
                ...
                <Box display="flex" justifyContent="space-between">
                    ...
                    <Typography gutterBottom variant="subtitle1">our of {place.num_reviews} reviews</Typography>
                </Box>
                <Box display="flex" justifyContent="space-between">
                ...
                {place?.awards?.map((item) => (
                    <Box my={1} display="flex" justifyContent="space-between">
                        <img src={item.images.small} alt={item.display_name} />
                        <Typography variant="subtitle2" color="textSecondary">{item.display_name}</Typography>
                    </Box>
                ))}
